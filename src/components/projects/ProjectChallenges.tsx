        ...
        {challenges.map((item, index) => (
          <div key={index} className="space-y-2">
            <div className="flex items-start gap-3">
              <span className="mt-1 flex h-2 w-2 items-center justify-center rounded-full bg-slate-400 flex-shrink-0"></span>
              <span className="text-base leading-relaxed text-slate-700 font-medium xl:text-lg">
                {item.challenge}
              </span>
            </div>
